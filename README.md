...
<img align="right" height="96px" src="https://memos.innerinfo.cloud/logo-rounded.png" alt="Memos" />

An open-source, self-hosted note-taking solution designed for seamless deployment and multi-platform access. Experience effortless plain text writing with pain-free, complemented by robust Markdown syntax support for enhanced formatting.

<a href="https://memos.innerinfo.cloud">Home Page</a> •
<a href="https://memos.innerinfo.cloud/blog">Blogs</a> •
<a href="https://memos.innerinfo.cloud/docs">Docs</a> •
<a href="https://demos.innerinfo.cloud/">Live Demo</a>
...
![demo]([http://gaon.innerinfo.cloud/theme/thema/assets/images/logo.png])
...
> [!NOTE]
> This command is only applicable for Unix/Linux systems. For Windows, please refer to the detailed [documentation](https://memos.innerinfo.cloud/docs/install/container-install#docker-on-windows).
>
> The `~/.memos/` directory will be used as the data directory on your local machine, while `/var/opt/memos` is the directory of the volume in Docker and should not be modified.

Learn more about [other installation methods](https://memos.innerinfo.cloud/docs/install).
...
Guide to [contribution](https://memos.innerinfo.cloud/docs/contribute).
